...
*   **Core AI Flows (`src/ai/flows/`)**:
    ...
    1.  **`generateInterviewKit`**:
        *   **Input**: `jobDescription`, `unstopProfileLink` (compulsory, conceptually analyzed), `candidateResumeText` (optional, from pasted/extracted resume text including projects, tech stack, goals, accomplishments, challenges, educational background, academic achievements, and past work experiences), `candidateExperienceContext`.
    ...
    2.  **`customizeInterviewKit`**:
        *   **Input**: Full current kit state, including original JD, Unstop profile link, resume text (including projects, tech stack, goals, accomplishments, challenges, educational background, academic achievements, and past work experiences), context, and user edits.
...
1.  **Input**: User pastes JD, provides a **compulsory Unstop Profile Link**, and optionally selects a resume file (then pastes extracted text for now, including projects, tech stack, goals, accomplishments, challenges, educational background, academic achievements, and past work experiences) into `JobDescriptionForm.tsx`.
...
This report reflects the application's design, emphasizing a recruiter-centric companion approach suitable for **non-technical evaluators**, with input methods for compulsory Unstop profiles and optional resume text (simulating uploads, including project details, tech stack, goals, accomplishments, challenges, educational background, academic achievements, and past work experiences), and guidance on evaluating emergent candidate information.
