...
*   **Model Answers are Generalized Evaluation Guides, Not Rigid Scripts:**
    ...
    *   **CRITICAL "Note for Interviewer" Section:** Every single model answer MUST include a "Note for the Interviewer" that provides a framework for evaluation. This note should guide the recruiter on how to assess answers, instructing them to listen for:
