...
4.  For EACH question (including "Tell me about yourself" and resume project/background questions), provide all the fields as specified in the output schema, paying close attention to the descriptions:
    ...
    *   \`answer\`: A model answer as 3-4 concise bullet points.
        *   For general questions: Each bullet point MUST serve as a **general example of a strong answer** for this role and candidate profile – **basic, clear, and easy to judge**. Crucially, these answers must also demonstrate proficiency relevant to the candidate's **specific work experience, past experiences (from resume/context, including projects and their specific details like tech stack, goals, accomplishments, challenges, educational background, academic achievements)** and background by EXPLICITLY referencing key terms, skills, **projects**, or experiences from the Job Description AND/OR the Candidate Resume/Context. Highlight positive indicators a recruiter should look for.
    ...
    const validatedOutput: GenerateInterviewKitOutput = {
      competencies: (output.competencies || []).map(comp => ({
        ...
        questions: (comp.questions || []).map(q => ({
          ...
          answer: q.answer || "Missing model answer (should be 3-4 bullet points referencing JD/resume/projects/education/context, serving as a general example of a strong answer, or tailored for 'Tell me about yourself' based on resume).",
