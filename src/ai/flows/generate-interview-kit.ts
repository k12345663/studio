...
2.  **Generate Questions in a Logical Sequence**:
    ...
    *   **Other competencies**:
        ...
        *   Follow with other distinct, insightful questions (2-3 total per competency): Technical, Scenario, Behavioral, sharply tailored to JD and specifics from Unstop profile/resume text/context (projects, tech stack, goals, accomplishments, challenges, education, past experiences). For many general technical or behavioral questions, while informed by the overall context, the focus **should lean significantly towards** fundamental principles rather than direct JD mapping for every point.

3.  **For EACH question, provide all fields as specified in the output schema**:
    *   \`question\`: Text of the question.
    *   \`answer\`: A model answer FROM THE INTERVIEWER'S PERSPECTIVE (3-4 concise bullet points). Each bullet MUST outline KEY POINTS A CANDIDATE SHOULD COVER for a strong answer, making it **exceptionally easy for a non-technical recruiter to judge**. Furthermore, each bullet point MUST also include a textual suggestion of its indicative weight or contribution towards the question's total 10-point score. For example, a bullet point could be followed by guidance like '(This point is crucial and could account for approx. 3-4 points of the total 10)' or '(Covers a foundational aspect, contributing roughly 2-3 points)'. This textual guidance is to help the panelist understand the relative importance of each point when they assign their overall 1-10 score for the question using the slider. The sum of these indicative contributions should conceptually align with a comprehensive answer deserving a high score. These points should serve as **general examples of strong answers**, reflecting core concepts (e.g., 'If OOP is asked, interviewer should note if candidate covers: 1. Abstraction. 2. Encapsulation. 3. Inheritance. 4. Polymorphism,' ensuring these pillars are clearly listed if relevant for a non-technical interviewer). While generally informed by the overall context (Job Description, candidate profile including Unstop link, resume text [treated as full text from PDF/DOC], projects, tech stack, goals, accomplishments, challenges, educational background, academic achievements, and past work experiences), **for many general questions, the key points should strongly emphasize fundamental concepts or general best practices for answering, rather than requiring every point to be explicitly tied to a specific line in the Job Description. The goal is to provide a solid baseline for evaluation.** Answers must be **basic, clear, and easy for a non-technical recruiter to evaluate**. EXPLICITLY reference key terms, skills, projects, or experiences from JD AND/OR Unstop Profile/Resume Text when crucial for context. Include guidance on evaluating real-life examples and relevant information shared by the candidate not present on the resume using a note like: 'Note: If the candidate provides relevant real-life examples or discusses experiences/skills not detailed on their resume/profile but clearly relevant to the role, this can indicate greater depth, initiative, or broader experience. The interviewer should assess the relevance and substance of such unstated information against the job requirements.'
        For the "Tell me about yourself" question: if a Unstop profile or resume text is available, the model answer MUST be a guide for the INTERVIEWER. It should outline key points from the candidate's specific background (such as their name, key qualifications, relevant educational background, academic achievements, significant projects from Unstop/resume, and notable work history) that would constitute a strong, relevant, and well-structured introduction. This model answer must be written from the interviewer's perspective to help a non-technical recruiter assess relevance and completeness against the candidate's documented profile, rather than being a script for the candidate.
