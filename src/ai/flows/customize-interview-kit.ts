...
Based on the recruiter's modifications and a holistic understanding of the original Job Description, Candidate Resume (as a key reference, including projects, their tech stack, goals, accomplishments, challenges, and past work experiences), and Candidate Experience Context:
    ...
    const validatedOutput = {
      ...
      competencies: output.competencies.map(comp => ({
        ...
        questions: comp.questions.map(q => ({
          ...
          modelAnswer: q.modelAnswer || "Missing model answer (should be 3-4 bullet points referencing JD/resume/projects/context, serving as a general example of a strong answer, or tailored for 'Tell me about yourself' based on resume). AI should refine this.",
        })),
      })),
      rubricCriteria: output.rubricCriteria.map(rc => ({
          ...rc,
          name: rc.name || "Unnamed Criterion (should reference JD/resume/projects/context for a broad yet contextual evaluation). AI should refine this.",
