...
const QuestionSchema = z.object({
  ...
  modelAnswer: z.string().describe("An example answer for the question, presented as 3-4 concise bullet points. Each bullet MUST serve as a **general example of a strong answer**, be basic, clear, and easy to judge, demonstrate proficiency for the target experience level (drawing from candidate's specific work experience, past experiences from resume/context, including projects and their specifics like tech stack, goals, accomplishments, challenges, educational background, academic achievements), and EXPLICITLY reference terms, skills, projects, or experiences from the Job Description, Candidate Resume, or context if appropriate. Ensure this format is maintained if modified. For 'Tell me about yourself', if a resume is provided, the model answer MUST be specifically tailored to outline 3-4 key points a strong candidate would ideally cover based on THEIR specific resume (including work history, projects, educational background, and academic achievements). For resume project deep-dive questions, the model answer should guide the interviewer on what to listen for regarding project goals, tech stack, accomplishments, and challenges. The candidate's resume (including projects, their tech stack, goals, accomplishments, challenges, educational background, academic achievements, and past work experiences) should be a key reference for validating and refining model answers."),
    ...
    const validatedOutput = {
      ...
      competencies: output.competencies.map(comp => ({
        ...
        questions: comp.questions.map(q => ({
          ...
          modelAnswer: q.modelAnswer || "Missing model answer. AI should provide general example answer (3-4 bullet points) covering key points, informed by JD/resume/context.",
        })),
      })),
