...
6.  Ensure all output fields (importance, category, difficulty, estimatedTimeMinutes, model answers from interviewer's perspective covering key points and referencing JD/Unstop Profile/Resume Text [treated as full text from PDF/DOC] and considering emergent details, **simple and clear for non-technical evaluation**) are present for all competencies and questions.
