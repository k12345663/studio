...
3.  Reflect changes to competency importance, question category ('Technical'/'Non-Technical'), question difficulty (5 levels), or estimated times. Ensure difficulty is one of the 5 allowed levels. If new questions are implicitly added, assign appropriate category, difficulty, estimated time, and ensure well-formed questions with concise model answers (interviewer's perspective, brief and crisp strong points to cover with indicative score contribution using whole numbers or small clear ranges of whole numbers, **simple and clear for non-technical evaluation**, collective contributions conceptually aligning to a full 10-point answer) strongly tied to the JD and candidate profile (Unstop/Resume file content). Ensure variety in questions; avoid asking multiple questions that probe the exact same skill or experience in only slightly different ways (e.g., TC-KEYWC*).
