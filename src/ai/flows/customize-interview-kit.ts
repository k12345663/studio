    ...
    const validatedOutput = {
      ...
      competencies: output.competencies.map(comp => ({
        ...
        questions: comp.questions.map(q => ({
          ...
          modelAnswer: q.modelAnswer || "Missing model answer (should be 3-4 bullet points referencing JD/resume/projects/education/context, serving as a general example of a strong answer, or tailored for 'Tell me about yourself' based on resume). AI should refine this.",
        })),
      })),
